...
int main(){
    ...
    cin>>number;
    cout<<"entered number "<<number<<endl;//output of variable
//num
    int num;
    num=12;
    cout<<num<<endl;
...
//num without initialisation it gives garbage value
    int nume;
    cout<<nume<<endl;
...
int main()
{
  ...
  //relational operator
   ...
   int car= 12;
   if(age<=18|| car>=1){
    cout<<"licence ligal"<<endl;

    cout<<!age<<endl;//if age will be 0 the it will show 1
}
